 ...
 * LoopbackBinary
 *****************************************/
var LoobackBinary = exports.LoobackBinary = 
function LoobackBinary(def) {
	meem.Meem.call(this, def, this._getProperties(def.properties), this._getFacets());
	this.value = false;		// the binary value
};
util.inherits(LoobackBinary, meem.Meem);

LoobackBinary.prototype._getProperties = function(config) {
	var properties = {};
	return properties;
};
 ...
 */
LoobackBinary.prototype._getFacets = function() {
	var self = this;
 ...
 * LoopbackLinear
 *****************************************/
var LoobackLinear = exports.LoobackLinear = 
function LoobackLinear(def) {
	meem.Meem.call(this, def, this._getProperties(def.properties), this._getFacets());
	this.value = 0;		// the linear value
	//this.unit = undefined;
};
util.inherits(LoobackLinear, meem.Meem);

LoobackLinear.prototype._getProperties = function(config) {
	var properties = {};
	return properties;
};
 ...
 * Define the facets for this Meem.
 */
LoobackLinear.prototype._getFacets = function() {
	var self = this;
	...
	var handleLinearIn = function(message) {
		if (self.value != message.value) {
			...
			// send value to output facet
			var outFacet = self.getFacet("linearOut");
			outFacet.handleMessage(message);
		}
	};
